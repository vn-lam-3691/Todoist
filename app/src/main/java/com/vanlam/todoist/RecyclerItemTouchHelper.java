...
public class RecyclerItemTouchHelper extends ItemTouchHelper.SimpleCallback {
    ...
    public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
        ...
        if (direction == ItemTouchHelper.LEFT) {    // Delete task
            ...
            builder.setNegativeButton(R.string.cancel_text_dialog, new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialogInterface, int i) {
    ...
    public void onChildDraw(@NonNull Canvas c, @NonNull RecyclerView recyclerView, @NonNull RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurrentlyActive) {
        ...
        if (dX > 0) {   // Swiping to the right
            ...
            background = new ColorDrawable(ContextCompat.getColor(adapter.getContext(), R.color.primaryColor));
        }
